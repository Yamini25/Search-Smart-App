...
public class MainActivity extends Activity implements OnClickListener {
 ...
 public static SharedPreferences prof;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        prof = getSharedPreferences(file, 0);
    }
	...
	public void onClick(View v) {
		...
		else if(data.equalsIgnoreCase("Enter your Stream of study"))
		{
		...
		{		
			...
			Toast.makeText(this, "Profile Built. Start Browsing ", Toast.LENGTH_LONG).show();
		  Intent intnt = new Intent(this, BrowserActivity1.class);
          startActivity(intnt);
          finish();		
	    }
	}
